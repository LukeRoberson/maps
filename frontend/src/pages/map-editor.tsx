 ...
 * @remarks
 * Leaflet is the 3rd party library used for map rendering and editing.
 * Geoman is the Leaflet plugin used for drawing and editing boundaries and annotations.
 *  
 * @exports MapEditor
 */
...
import AnnotationRenderer from '@/components/map/AnnotationRenderer';
import MapViewController from '@/components/map/MapViewController';
import BoundaryFadeOverlay from '@/components/map/BoundaryFadeOverlay';
import ReadOnlyPolygon from '@/components/map/ReadOnlyPolygon';
...
import type { Toast, ToastType } from '@/components/Molecules/ToastNotification';
...
/*
 * Update the icons that Leaflet uses.
 * Use the Leaflet CDN for icons, instead of local images.
 * 1. Delete the existing _getIconUrl method to prevent Leaflet from trying to load local images.
 * 2. Merge new options to point to the CDN URLs for the marker icons and shadow.
 * 3. Set tooltip anchor to [0, -32] to position tooltips above the marker instead of centered.
 */
...
const MapEditor: React.FC = () => {
    ...
    /*
     * Component definitions for the UI
     */
    ...
    // The actual component JSX returned by the MapEditor
    return (
        <div className="map-editor-page">
            ...
            {/* The main content area, split into the sidebar (for layer management and map settings) and the map container. */}
